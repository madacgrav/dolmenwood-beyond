-- ============================================================
-- EQUIPMENT CATALOG (reference data — read-only for all users)
-- ============================================================
create table public.catalog_items (
  id uuid primary key default gen_random_uuid(),
  name text not null,
  item_type text not null check (item_type in ('weapon', 'armor', 'gear', 'ammo', 'coin')),
...
create policy "All authenticated users can read the catalog"
