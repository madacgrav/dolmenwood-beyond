          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <button
                ...
                style={{ flex: 1, padding: '0.75rem', backgroundColor: 'var(--color-bg)', border: '1px solid var(--color-border)', borderRadius: '8px', cursor: 'pointer', color: 'var(--color-text)', minHeight: '44px' }}
              >
                Cancel
              </button>
              <button
                onClick={() => { onDelete(character.id); setShowDeleteConfirm(false); }}
                style={{ flex: 1, padding: '0.75rem', backgroundColor: 'var(--color-danger)', border: 'none', borderRadius: '8px', cursor: 'pointer', color: 'white', fontWeight: '600', minHeight: '44px' }}
              >
                Delete
              </button>
            </div>
